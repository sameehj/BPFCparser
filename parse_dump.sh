...
llvm-objdump -S --disassemble-all --print-imm-hex $SECTION $OBJECTFILE  | awk '{n=split($0,a,"\t"); if(n==3){split(a[2],b," "); print b[1]","substr(b[2],1,1)","substr(b[2],2,1)","b[3]b[4]","b[5]b[6]b[7]b[8]} next;}'
